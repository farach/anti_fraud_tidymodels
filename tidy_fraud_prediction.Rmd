...
I will introduce concepts one by one and slowly building on each topic. 
Eventually, most everything above will be covered. This is to say what follows
below is not the proper way to code or build a machine learning model - it's
the way I find it easiest to learn about tidymodels and machine learning 
pipelines generally.
...
fraud_wf_model <- final_fraud_wkfl$.workflow[[1]]
