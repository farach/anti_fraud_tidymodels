...
Here the last fit will fit the best model to the training set and evaluate on
the test set which is why we pass the fraud_split data to the function and not
just the training or the testing set.
